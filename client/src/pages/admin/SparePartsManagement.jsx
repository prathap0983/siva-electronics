          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-sm space-y-6">
            <div className="flex items-center gap-3 border-b border-slate-100 dark:border-slate-800 pb-4">
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-slate-400">Post a new genuine television component to catalog list.</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmitForm} className="space-y-6">
              ...
              <div className="space-y-1">
                <label className="text-xs font-bold text-slate-455 uppercase">Part Name *</label>
                <input
                  type="text"
                  required
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-xs font-bold text-slate-455 uppercase">Compatible Brand</label>
                  <select
                    value={brandId}
                ...
                <div className="space-y-1">
                  <label className="text-xs font-bold text-slate-455 uppercase">Price (₹) *</label>
                  <input
                    type="number"
                    required
              ...
              <div className="space-y-1">
                <label className="text-xs font-bold text-slate-455 uppercase">Compatible Models (Comma Separated)</label>
                <input
                  type="text"
              ...
              {!editingPart && (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 bg-slate-50 dark:bg-slate-850 rounded-xl">
                  <div className="space-y-1">
                    <label className="text-xs font-bold text-slate-455 uppercase">Initial Quantity</label>
                    <input
                      type="number"
                      value={stockQty}
                  ...
                  <div className="space-y-1">
                    <label className="text-xs font-bold text-slate-455 uppercase">Low Stock Alert at</label>
                    <input
                      type="number"
              ...
              <label className="flex items-center gap-2.5 cursor-pointer">
                ...
                />
                <span className="text-sm font-semibold text-slate-850 dark:text-slate-200">Part is Available for Orders</span>
              </label>
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden shadow-sm">
              <div className="overflow-x-auto">
                <table className="w-full border-collapse text-left text-sm">
                  <thead>
                    <tr className="bg-slate-50 dark:bg-slate-855/50 border-b border-slate-200 dark:border-slate-800 text-xs font-bold text-slate-400 uppercase tracking-widest">
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                    {parts.map((part) => (
                      <tr key={part.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-850/20 transition-colors">
                        ...
                        <td className="px-6 py-4 text-slate-500 max-w-[240px] truncate" title={part.compatible_models.join(', ')}>
                          {part.compatible_models.length > 0 ? part.compatible_models.join(', ') : 'Universal'}
                        </td>
                        <td className="px-6 py-4 text-slate-500">
                          {part.brand?.name || 'Universal / Generic'}
                        </td>
