          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-sm space-y-6">
            <div className="flex items-center gap-3 border-b border-slate-100 dark:border-slate-800 pb-4">
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-slate-400">Post a new diagnostic or repair highlight to the gallery portfolio.</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-1">
                <label className="text-xs font-bold text-slate-455 uppercase">Photo Title *</label>
                <input
                  type="text"
                  required
                  placeholder="e.g. Sony 43 inch backlight assembly repair"
                  value={title}
              ...
              <div className="space-y-1">
                <label className="text-xs font-bold text-slate-455 uppercase">Gallery Category *</label>
                <select
                  value={category}
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold text-slate-455 uppercase block">Media File (Cloudinary stream)</label>
                <DragDropUpload
